...
import com.training.digitalgoldloan.service.AddressService;
...
public class AddressRestController {
	...
	public ResponseEntity<String> addAddress(@Valid @RequestBody Address address) {
		...
		return ResponseEntity.status(HttpStatus.CREATED).body(env.getProperty("AddressService.ADDED"));
	}
	...
	public ResponseEntity<String> updateAddress(@PathVariable("address_id") Integer addressId,
		...
		return ResponseEntity.ok(env.getProperty("AddressService.UPDATED"));
	}
